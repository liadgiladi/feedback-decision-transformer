...
class LearningRateDecayCallback(pl.Callback):
    ...
    def on_train_batch_end(self, trainer, pl_module, outputs, batch, batch_idx):
        ...
        states, actions, rtgs, timesteps, _, _, _ = batch
        y = actions
        ...
        pl_module.log("lr", lr, prog_bar=True, on_step=True, on_epoch=False, logger=True)
        pl_module.logger.experiment.log({"lr": lr})