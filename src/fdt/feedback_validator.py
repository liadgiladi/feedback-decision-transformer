...
class FeedbackValidator:
    def __init__(self, augment_only_sparse_reward_with_synthetic_oracle_feedback: bool, verbose: int = 0):
        ...
        self.align_first_trajectory = False  # in breakout for example, the first trajectory is not started from the beginning of the game, need to wait to finish and then mark as aligned

    def is_feedback_allow(self):
...
class SeaquestFeedbackValidator(FeedbackValidator):
    def __init__(self, augment_only_sparse_reward_with_synthetic_oracle_feedback: bool):
        super(SeaquestFeedbackValidator, self).__init__(augment_only_sparse_reward_with_synthetic_oracle_feedback)
    ...
    def is_feedback_allow(self, enable_sticky_action_logic: bool = True):
        if not super(SeaquestFeedbackValidator, self).is_feedback_allow():
            return False
...
class QbertFeedbackValidator(FeedbackValidator):
    def __init__(self, augment_only_sparse_reward_with_synthetic_oracle_feedback: bool):
        super(QbertFeedbackValidator, self).__init__(augment_only_sparse_reward_with_synthetic_oracle_feedback)
    ...
    def is_feedback_allow(self, enable_sticky_action_logic: bool = True):
        if not super(QbertFeedbackValidator, self).is_feedback_allow():
            return False
...
class PongFeedbackValidator(FeedbackValidator):
    def __init__(self, augment_only_sparse_reward_with_synthetic_oracle_feedback: bool):
        super(PongFeedbackValidator, self).__init__(augment_only_sparse_reward_with_synthetic_oracle_feedback)
    ...
    def is_feedback_allow(self, enable_sticky_action_logic: bool = True):
        if not super(PongFeedbackValidator, self).is_feedback_allow():
            return False
...
class BreakoutFeedbackValidator(FeedbackValidator):
    def __init__(self, augment_only_sparse_reward_with_synthetic_oracle_feedback: bool):
        super(BreakoutFeedbackValidator, self).__init__(augment_only_sparse_reward_with_synthetic_oracle_feedback)
    ...
    def is_feedback_allow(self, enable_sticky_action_logic: bool = True):
        if not super(BreakoutFeedbackValidator, self).is_feedback_allow():
            return False
    ...
    def handle_step(self, state, action, reward, terminal, next_state, next_action, index):
        super(BreakoutFeedbackValidator, self).handle_step(state, action, reward, terminal, next_state, next_action, index)
